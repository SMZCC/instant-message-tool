/**
 * @author 流浪大法师
 * @time 2016-2-14 下午11:45:09
 * @email liuliangsir@gmail.com
 * @descript 封装实现数据库的CRUD相关的底层操作
 * @warning 注意将字符集设置成UTF-8
 */
package com.vince.model.dao.common;
...
import com.vince.model.common.PageBean;
import com.vince.model.util.ReflectionUtil;
import com.vince.model.util.SQLUtil;
