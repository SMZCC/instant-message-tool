...
public class RotateImageDemo extends JFrame{
    ...
    public RotateImageDemo(){
        ...
        //System.out.println(this.getClass().getClassLoader().getResource("./images/qqZoneUntouch.png").getPath());
        imagePane.loadImage(this.getClass().getClassLoader().getResource("./images/qqZoneUntouch.png").getPath());    //装载图片
